...
[SL2C_290FailureK TempL2C_290FailureK]=importfile('dataFiles/L2C01WarmFailureMode22May.txt'); %import the 290K cable data
[SL2C_10FailureK TempL2C_10FailureK]=importfile('dataFiles/L2C01ColdFailureMode22May.txt'); %import the 290K cable data
...
ylim([-15 -8])
grid on
print -depsc2 LossL2C+Coupler+Hybridzoomed

figure
plot(SCable290K22may(:,1),SCable290K22may(:,3)-mean(SCable290K22may(:,3)),'r')
hold on
plot(SCable10K22may(:,1),SCable10K22may(:,3)-mean(SCable290K22may(:,3)),'b.-')
legend('290K','10K');
...
hold on
plot(SL2C_10FailureK(:,1),-(SCable10K22may(:,3)-SL2C_10FailureK(:,3)),'b.-')
legend('290K','10K');
