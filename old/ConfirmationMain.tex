...
\documentclass[english,a4paper,titlepage,12pt]{article}
...
\lhead{}
\rhead{}
\chead{\large Report for Confirmation of D.Phil Status }
...
\input{introductionNew.tex} \clearpage
\input{rfimain.tex}\clearpage
\input{digitalRX.tex} \clearpage
...
\clearpage
\singlespace
\bibliography{./bib_files/references}
